...
01_matching.py
--------------
Propensity Score Matching (PSM) for each ADD event.
...
OUTPUT_PATH = ROOT / "data" / "results" / "matched_pairs.csv"
...
for i, row in unique_events.iterrows():
    ...
    # ── Nearest neighbor on propensity score ────────────────
    ...
    if n_attempted % 20 == 0 or n_attempted == n_events:
        print(
