"""
02_did_estimation.py  [STOXX 50 PROXY]
----------------------------------------
...
Output: stoxx50/data/results/did_results_synchronicity.csv,
        stoxx50/data/results/did_results_idiovol.csv
"""
...
OUT_SYNCH = SX50_ROOT / "data" / "results" / "did_results_synchronicity.csv"
OUT_IVOL = SX50_ROOT / "data" / "results" / "did_results_idiovol.csv"
...
def run_panel_did(data, dep_var, label):
    ...
    y = data[dep_var]
    X = data[["Treat_Post", "Amihud", "Turnover"]]
