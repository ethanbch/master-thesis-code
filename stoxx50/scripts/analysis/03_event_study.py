"""
03_event_study.py  [STOXX 50 PROXY]
--------------------------------------
...
Output: stoxx50/figures/event_study_synchronicity.png,
        stoxx50/figures/event_study_idiovol.png
"""
...
def plot_event_study(taus, coefs, ci_lower, ci_upper, label, filename):
    ...
    ax.set_title(
        f"Event Study — {label}\n"
        f"EURO STOXX 50 Proxy | Dynamic DiD, Entity & Time FE, clustered SE",
        fontsize=13,
    )
    ax.set_xticks(taus)
