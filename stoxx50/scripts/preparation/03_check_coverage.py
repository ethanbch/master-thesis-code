"""
03_check_coverage.py  [STOXX 50 PROXY]
---------------------------------------
...
Output: stoxx50/data/intermediate/events.csv (updated with ric column),
        stoxx50/data/intermediate/missing_add_tickers.csv
"""
...
print("\nOutputs saved: stoxx50/data/intermediate/missing_add_tickers.csv")
