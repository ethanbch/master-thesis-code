"""
06_build_features.py  [STOXX 50 PROXY]
----------------------------------------
For each ADD event (rank ≤ 50 proxy), compute pre-event PSM features
...
Output: stoxx50/data/intermediate/features_at_event.csv
"""
...
OUTPUT_PATH = SX50_ROOT / "data" / "intermediate" / "features_at_event.csv"
MIN_OBS = 200
WINDOW_DAYS = 365
