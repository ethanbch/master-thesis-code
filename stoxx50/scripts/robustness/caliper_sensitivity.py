"""
caliper_sensitivity.py  [STOXX 50 PROXY]
------------------------------------------
...
Output: stoxx50/data/results/robustness_caliper_results.csv
"""
...
FEATURES_PATH = SX50_ROOT / "data" / "intermediate" / "features_at_event.csv"
PANEL_PATH = SX50_ROOT / "data" / "intermediate" / "panel_monthly.parquet"
OUT_CSV = SX50_ROOT / "data" / "results" / "robustness_caliper_results.csv"
...
print("=" * 60)
print("  ROBUSTNESS — Caliper sensitivity [EURO STOXX 50 Proxy]")
print("  Y = Synchronicity")
print("=" * 60)
print(
